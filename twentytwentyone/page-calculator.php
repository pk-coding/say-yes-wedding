...
<div id="calculator-container">
    ...
    <nav class="panel-nav">
        ...
        <?php if (!is_user_logged_in()) : ?>
            <a href="<?php echo esc_url(home_url('/logowanie')); ?>"><button>Zaloguj się</button></a>
        <?php endif; ?>
        ...
        <h1 id="main-title">Kalkulator Ślubny</h1>
    </nav>
        ...
        <div class="categories-container">
                ...
                <div class="subcategory" id="noclegi">
                    ...
                    <div class="slider-row">
                        <label for="apartament">
                            <span class="label-line">Apartament</span>
                            <span class="label-line">dla pary:</span>
            ...
            <div class="category-box" id="box-inne" data-category="inne">
                ...
                <div class="subcategory" id="inne">
                    ...
                    <div class="slider-row">
                        <label for="oplata-usc">
                            <span class="label-line">Opłaty</span>
